    ...
    return (
        <div className="mainPage">
            ...
            <div className="newProducts">
                ...
                {data.map((item,index)=> item.loai==="keyboard" &&<ContainerItem price={item.price} name={item.name} img={item.hinh} maSp={item.maSp}/>)}
                </Slider>
            ...
            <div className="bestSeller">
                ...
                <Slider {...settings}>
                    {data.map((item,index)=> item.loai==="loa"
            ...
            <div className="onSale">
                ...
                <Slider {...settings}>
                    ...
                    {data.map((item,index)=> item.loai==="sacDp"
                    &&<ContainerItem price={item.price} name={item.name} img={item.hinh} maSp={item.maSp}/>)}  
                </Slider>
